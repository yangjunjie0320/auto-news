...
_HANDLER_MARKER = "_auto_news_monitor_handler"
...
def setup(
    ...
    *,
    ...
    managed_streams = [
        handler for handler in root.handlers if getattr(handler, _HANDLER_MARKER, None) == "console"
    ]
    ...
    log_path = str(Path(log_dir, "auto-news-monitor.log").resolve())
    managed_files = [
        handler
    ...
    if not managed_files:
        file_handler = logging.handlers.RotatingFileHandler(
            filename=os.path.join(log_dir, "auto-news-monitor.log"),
